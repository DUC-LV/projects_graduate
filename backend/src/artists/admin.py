...
from .models import Artists, ArtistOfPlaylist, ArtistOfAlbum, ArtistOfSong, ArtistOfVideos
...
@admin.register(ArtistOfVideos)
class ArtistOfVideos(admin.ModelAdmin):
